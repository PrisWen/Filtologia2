...
namespace Fitologia.View
{
    ...
    public sealed partial class Main : Page
    {
        ...
        private void GridView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                DataTemas temp = index.SelectedItem as DataTemas;
                if (index.SelectedIndex==0)
                {
                    this.Frame.Navigate(typeof(Page1), temp.Id);    
                }
                ...
                //{
                //    this.Frame.Navigate(typeof(HubPage1));
                //}
